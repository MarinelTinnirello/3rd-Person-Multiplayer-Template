...
#include "MPShooter/Item/Pickup/ShieldPickup.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeShieldPickup() {}
// Cross Module References
	MPSHOOTER_API UClass* Z_Construct_UClass_AShieldPickup_NoRegister();
	MPSHOOTER_API UClass* Z_Construct_UClass_AShieldPickup();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AShieldPickup_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Item/Pickup/ShieldPickup.h" },
		{ "ModuleRelativePath", "Item/Pickup/ShieldPickup.h" },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AShieldPickup_Statics::NewProp_ShieldReplenishAmount_MetaData[] = {
		{ "Category", "Shield Pickup Properties" },
		{ "ModuleRelativePath", "Item/Pickup/ShieldPickup.h" },
		{ "ToolTip", "Amount replenished on pickup." },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AShieldPickup_Statics::NewProp_ShieldReplenishTime_MetaData[] = {
		{ "Category", "Shield Pickup Properties" },
		{ "ModuleRelativePath", "Item/Pickup/ShieldPickup.h" },
		{ "ToolTip", "Amount of time it takes to reach ShieldReplenishAmount." },
	};
#endif
	...
	template<> MPSHOOTER_API UClass* StaticClass<AShieldPickup>()
	{
		return AShieldPickup::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AShieldPickup);
	struct Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Pickup_ShieldPickup_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Pickup_ShieldPickup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AShieldPickup, AShieldPickup::StaticClass, TEXT("AShieldPickup"), &Z_Registration_Info_UClass_AShieldPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShieldPickup), 1902328124U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Pickup_ShieldPickup_h_1483617776(TEXT("/Script/MPShooter"),
		Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Pickup_ShieldPickup_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Pickup_ShieldPickup_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
