...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_MPShooter_EHitActor_Statics::Enum_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Item/Weapon/HitActor.h" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_HitActor_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_HitActor_h_Statics::EnumInfo[] = {
		{ EHitActor_StaticEnum, TEXT("EHitActor"), &Z_Registration_Info_UEnum_EHitActor, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1164476550U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_HitActor_h_1051058707(TEXT("/Script/MPShooter"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_HitActor_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_HitActor_h_Statics::EnumInfo));
