...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_AProjectile_MulticastOnHit_Statics::NewProp_HitActorType = { "HitActorType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Projectile_eventMulticastOnHit_Parms, HitActorType), Z_Construct_UEnum_MPShooter_EHitActor, METADATA_PARAMS(nullptr, 0) }; // 1164476550
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AProjectile_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AProjectile_MulticastOnHit, "MulticastOnHit" }, // 3075487686
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_Ranged_Projectile_Projectile_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AProjectile, AProjectile::StaticClass, TEXT("AProjectile"), &Z_Registration_Info_UClass_AProjectile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AProjectile), 3493186603U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_Ranged_Projectile_Projectile_h_1084613704(TEXT("/Script/MPShooter"),
