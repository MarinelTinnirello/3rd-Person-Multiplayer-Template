...
// Cross Module References
	...
	MPSHOOTER_API UClass* Z_Construct_UClass_ACasing();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACasing_OnHit_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Item/Weapon/Ranged/Projectile/Misc/Casing.h" },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACasing_Statics::NewProp_ShellEjectionImpulse_MetaData[] = {
		{ "Category", "Casing Properties" },
		{ "ModuleRelativePath", "Item/Weapon/Ranged/Projectile/Misc/Casing.h" },
		{ "ToolTip", "Impulse of a casing shell when it's ejected from a weapon." },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACasing_Statics::NewProp_ShellSound_MetaData[] = {
		{ "Category", "Casing Properties" },
		{ "ModuleRelativePath", "Item/Weapon/Ranged/Projectile/Misc/Casing.h" },
		{ "ToolTip", "Sound that plays when a shell hits an object." },
	};
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACasing_Statics::NewProp_LifeSpan_MetaData[] = {
		{ "Category", "Casing Properties" },
		{ "ModuleRelativePath", "Item/Weapon/Ranged/Projectile/Misc/Casing.h" },
		{ "ToolTip", "Lifetime of a casing shell when spawned." },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACasing_Statics::NewProp_LifeSpan = { "LifeSpan", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACasing, LifeSpan), METADATA_PARAMS(Z_Construct_UClass_ACasing_Statics::NewProp_LifeSpan_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACasing_Statics::NewProp_LifeSpan_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACasing_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACasing_Statics::NewProp_LifeSpan,
	};
	...
	template<> MPSHOOTER_API UClass* StaticClass<ACasing>()
	{
		return ACasing::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ACasing);
	struct Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_Ranged_Projectile_Misc_Casing_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_Ranged_Projectile_Misc_Casing_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACasing, ACasing::StaticClass, TEXT("ACasing"), &Z_Registration_Info_UClass_ACasing, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACasing), 212212730U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_Ranged_Projectile_Misc_Casing_h_654537432(TEXT("/Script/MPShooter"),
		Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_Ranged_Projectile_Misc_Casing_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_Item_Weapon_Ranged_Projectile_Misc_Casing_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
