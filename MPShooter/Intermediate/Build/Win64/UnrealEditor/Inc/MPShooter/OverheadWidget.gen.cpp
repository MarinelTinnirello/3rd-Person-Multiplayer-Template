...
// Cross Module References
	MPSHOOTER_API UClass* Z_Construct_UClass_UOverheadWidget_NoRegister();
	MPSHOOTER_API UClass* Z_Construct_UClass_UOverheadWidget();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DisplayTxt_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_DisplayTxt;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOverheadWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOverheadWidget_ShowPlayerName, "ShowPlayerName" }, // 1709067975
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOverheadWidget_Statics::NewProp_DisplayTxt_MetaData[] = {
		{ "BindWidget", "" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "HUD/OverheadWidget.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UOverheadWidget_Statics::NewProp_DisplayTxt = { "DisplayTxt", nullptr, (EPropertyFlags)0x0010000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOverheadWidget, DisplayTxt), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UOverheadWidget_Statics::NewProp_DisplayTxt_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOverheadWidget_Statics::NewProp_DisplayTxt_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOverheadWidget_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOverheadWidget_Statics::NewProp_DisplayTxt,
	};
	...
	template<> MPSHOOTER_API UClass* StaticClass<UOverheadWidget>()
	{
		return UOverheadWidget::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UOverheadWidget);
	struct Z_CompiledInDeferFile_FID_MPShooter_Source_MPShooter_HUD_OverheadWidget_h_Statics
	{
