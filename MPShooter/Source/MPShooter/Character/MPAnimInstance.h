...
private:
	...
	bool bIsCrouched;
	UPROPERTY(BlueprintReadOnly, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Checks if a character has a weapon equipped."))
	bool bWeaponEquipped;
	class AWeapon* EquippedWeapon;
	UPROPERTY(BlueprintReadOnly, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Checks if a character is aiming."))
	bool bAiming;
	...
	float AO_Pitch;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Character's hand bone where the weapon is equipped. Most animation packs will be right handed, so the right hand is what you're likely to fill in."))
	FName EquippedHandBone;	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Weapon's socket where the weapon is attached to the character. Most animation packs will be right handed, so the right hand socket is what you're likely to fill in."))
	FName EquippedHandSocket;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Weapon's socket where the character's free hand is attached. Most animation packs will be right handed, so the left hand socket is what you're likely to fill in."))
	FName SecondaryHandSocket;
	UPROPERTY(BlueprintReadOnly, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Character's hand bone transform to be used as the effector for FABRIK. This will be the transform of the SecondaryHandSocket."))
	FTransform SecondaryHandTransform;
	UPROPERTY(BlueprintReadOnly, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Character's hand bone rotation to be used as the replacement rotation on Transform (Modify) Bone. This will be the rotation of the EquippedHand."))
	...
	bool bUseFABRIK;
	UPROPERTY(BlueprintReadOnly, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Checks if we should use Aim Offset for a particular animation."))
	bool bUseAimOffsets;
	UPROPERTY(BlueprintReadOnly, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Checks if we should transform the equipped hand for a particular animation."))
	bool bTransformEquippedHand;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Hand socket where throwable weapons are placed."))
	FName ThrowableSocket;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (ToolTip = "Spine or back socket where weapons not currently in use are placed."))
